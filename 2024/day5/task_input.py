...
_task_input2_ = _task_input_


def parse_input(ti, ti_) -> ...:
    return ti, ti_


test1 = parse_input(_test1, _test1_)
test2 = parse_input(_test2, _test2_)
task_input = parse_input(_task_input, _task_input_)
task_input2 = parse_input(_task_input2, _task_input2_)
